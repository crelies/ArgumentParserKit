...
@testable import ArgumentParserKit
import XCTest
...
class URLTests: XCTestCase {
    func testSchema() {
        XCTAssertEqual(URL.scheme("http://github.com/foo/bar"), "http")
        XCTAssertEqual(URL.scheme("https://github.com/foo/bar"), "https")
        XCTAssertEqual(URL.scheme("HTTPS://github.com/foo/bar"), "https")
        XCTAssertEqual(URL.scheme("git@github.com/foo/bar"), "git")
        XCTAssertEqual(URL.scheme("ssh@github.com/foo/bar"), "ssh")
        XCTAssertNil(URL.scheme("github.com/foo/bar"))
        XCTAssertNil(URL.scheme("user:/github.com/foo/bar"))
    }
